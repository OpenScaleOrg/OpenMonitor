...
// COpenMonitorDlg 对话框
class COpenMonitorDlg : public CDialog
{
    // 构造
public:
    COpenMonitorDlg(CWnd* pParent = NULL);   // 标准构造函数
    ~COpenMonitorDlg();
    CTaskBarDlg* GetTaskbarWindow() const;

    static COpenMonitorDlg* Instance();

    // 对话框数据
#ifdef AFX_DESIGN_TIME
    enum { IDD = IDD_OPENMONITOR_DIALOG };
#endif

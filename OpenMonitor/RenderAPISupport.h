...
#define OPENMONITOR_HAS_FUNCTION_CALL(function_name, class_name) \
    ::is_function_##function_name##_exist<class_name>::value
#define OPENMONITOR_DEFINE_HAS_FUNCTION_CALL(function_name)                 \
    template <typename T>                                                      \
...
OPENMONITOR_DEFINE_HAS_FUNCTION_CALL(AddResource);
OPENMONITOR_DEFINE_HAS_FUNCTION_CALL(RemoveResource);
OPENMONITOR_DEFINE_HAS_FUNCTION_CALL(Recreate);
...
#define OPENMONITOR_DV_V_ARGS(v) decltype(v), v
...
{
    CallFunctionForEachResource<OPENMONITOR_DV_V_ARGS(&Resource::OnDeviceRecreate)>(tracker, device);
}
...
private:
    static_assert(OPENMONITOR_HAS_FUNCTION_CALL(AddResource, Storage), "Function Storage::AddResource not found.");
    static_assert(OPENMONITOR_HAS_FUNCTION_CALL(RemoveResource, Storage), "Function Storage::RemoveResource not found.");

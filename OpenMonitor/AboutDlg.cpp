...
BOOL CAboutDlg::OnInitDialog()
{
    ...
    m_mail.SetURL(_T("mailto:suman.debnath@ascentt.com"));   //设置超链接
    //m_check_update.SetURL(_T("http://pan.baidu.com/s/1c1LkPQ4"));
    m_github.SetURL(_T("https://github.com/OpenScaleOrg/OpenMonitor"));
    ...
    m_musicplayer2_link.SetURL(_T("https://github.com/OpenScaleOrg/MusicPlayer2"));
    m_simplenotepad_link.SetURL(_T("https://github.com/OpenScaleOrg/SimpleNotePad"));

...
// OpenMonitor.h : PROJECT_NAME 应用程序的主头文件
//
...
// COpenMonitorApp:
// 有关此类的实现，请参阅 OpenMonitor.cpp
//


class COpenMonitorApp : public CWinApp, public IOpenMonitor
{
public:
    //各种路径
    static COpenMonitorApp* self;
...
public:
    ...
    //由于本函数中使用了COpenMonitorApp::DPI函数，因此本函数必须确保在COpenMonitorApp::DPIFromWindow之后调用

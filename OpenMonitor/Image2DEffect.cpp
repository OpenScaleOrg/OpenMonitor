...
void CImage2DEffect::RecreateUnmodifiableResource(Microsoft::WRL::ComPtr<ID3D10Device1> p_device1)
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateInputLayout(
            ...
            &m_p_input_layout),
        OPENMONITOR_ERROR_STR("CImage2DEffect call CreateInputLayout failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateBuffer(
            ...
            &vertex_data,
            &m_p_vertex_buffer),
        OPENMONITOR_ERROR_STR("CImage2DEffect create vertex buffer failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateBuffer(
            ...
            &index_data,
            &m_p_index_buffer),
        OPENMONITOR_ERROR_STR("CImage2DEffect create index buffer failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("CImage2DEffect create rasterizer state failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("CImage2DEffect create default sampler state failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateBlendState1(
            &blend_desc1,
            &m_p_blend_state1),
        OPENMONITOR_ERROR_STR("CImage2DEffect create D3D10.1 blend state for alpha blend failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("CImage2DEffect call CreateDepthStencilState failed."));
}
...
void CImage2DEffect::RecreateInputTextureRelatedResources(Microsoft::WRL::ComPtr<ID3D10Texture2D> p_input)
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("CImage2DEffect create shader resource view1 failed."));
}
...
void CImage2DEffect::RecreateOutputTextureRelatedResources(Microsoft::WRL::ComPtr<ID3D10Texture2D> p_output)
{
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("CImage2DEffect create D3D10.1 render target view failed."));
}
...
void CImage2DEffect::RecreateVsByteCodeRelatedResources(Microsoft::WRL::ComPtr<ID3DBlob> p_vs_byte_code)
{
    ThrowIfFailed<CD3D10Exception1>(
        m_p_owner_device1->CreateVertexShader(
            ...
            &m_p_vs),
        OPENMONITOR_ERROR_STR("CImage2DEffect create vertex shader failed."));
}
...
void CImage2DEffect::RecreatePsByteCodeRelatedResources(Microsoft::WRL::ComPtr<ID3DBlob> p_ps_byte_code)
{
    ThrowIfFailed<CD3D10Exception1>(
        m_p_owner_device1->CreatePixelShader(
            ...
            &m_p_ps),
        OPENMONITOR_ERROR_STR("CImage2DEffect create pixel shader failed."));
}

...
#define OPENMONITOR_ENUM_AND_EXPLANATION(enumeration, explanation) \
...
void DrawCommonHelper::LogDeviceRecreateReason(HRESULT hr)
{
    const static std::unordered_map<HRESULT, const char*> removed_reason{
        {OPENMONITOR_ENUM_AND_EXPLANATION(
        ...
        [](auto* p_content)
        {
            ...
            if (!Win32HBITMAPVerifier::Verify(current_hbitmap))
            {
                throw std::runtime_error{
                    OPENMONITOR_ERROR_STR("Create ARGB32 DIB (size = 1x1, alpha = 1) failed.")};
            }
...
CTaskBarDlgDrawCommonSupport::CTaskBarDlgDrawCommonSupport()
{
    ...
    ThrowIfFailed<CD2D1Exception>(
        ...
        OPENMONITOR_ERROR_STR("Create GDI PS_DOT like stroke style failed."));
...
void CTaskBarDlgDrawCommonSupport::RecreateDCompositionDevice(const HRESULT recreate_reason)
{
    ...
    if (p_d3d10_device1)
    {
        ...
        ThrowIfFailed<CD3D10Exception1>(
            ...
            OPENMONITOR_ERROR_STR("Get dxgi device from d3d10 device1 failed."));
        m_dcomposition_device.Recreate(p_dxgi_device);
        return;
    }
    throw std::runtime_error{OPENMONITOR_ERROR_STR("D3D10 device not available.")};
}
    ...
    -> Microsoft::WRL::ComPtr<ID3D10Texture2D>
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateTexture2D(
            ...
            NULL,
            &result),
        OPENMONITOR_ERROR_STR("Create default 2D texture failed."));
    ...
    -> Microsoft::WRL::ComPtr<ID3D10Texture2D>
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateTexture2D(
            ...
            NULL,
            &result),
        OPENMONITOR_ERROR_STR("Create CPU writeable 2D texture failed."));
...
float4 PS(VsOutput ps_in) : SV_TARGET
{
    ...
    [flatten] if (color.w > )" OPENMONITOR_ONE_IN_255_FLOOR " && color.w < " OPENMONITOR_ONE_IN_255_CEIL ")"
                         R"(
    {
        color.w = 0.0;
        return color;
...
void CTaskBarDlgDrawCommonWindowSupport::CD3DGdiInteropHelper::Resize(D2D1_SIZE_U size)
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("Get IDXGISurface1 from D2D gdi_initial_texture failed."));
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("Get IDXGISurface1 from D2D gdi_final_texture failed."));
...
void CTaskBarDlgDrawCommonWindowSupport::SetGdiInteropTexture(void* p_data, D2D1_SIZE_U size)
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        m_d3d_gdi_interop_helper.m_p_gdi_initial_texture->Map(
            ...
            0,
            &mapped_texture),
        OPENMONITOR_ERROR_STR("Map m_p_gdi_initial_texture failed."));
    ...
    if (m_h_last_font != h_font)
    {
        ...
        ThrowIfFailed<CDWriteException>(
            CDWriteSupport::GetFactory()->CreateTextFormat(
                ...
                L"",
                &m_p_text_format),
            OPENMONITOR_ERROR_STR("Create D2D1 Text Format failed."));
...
void CD2D1DeviceContextWindowSupport::CD2D1DeviceContextHelper::Reinitialize()
{
    ...
    ThrowIfFailed<CD2D1Exception>(
        m_p_device->CreateDeviceContext(
            options,
            &m_p_device_context),
        OPENMONITOR_ERROR_STR("Create D2D1 device context failed."));
    ThrowIfFailed<CD2D1Exception>(
        m_p_device_context->CreateSolidColorBrush(
            m_foreground_color,
            &m_p_foreground_color_brush),
        OPENMONITOR_ERROR_STR("Create foreground solid color brush failed."));
    ThrowIfFailed<CD2D1Exception>(
        m_p_device_context->CreateSolidColorBrush(
            m_background_color,
            &m_p_background_color_brush),
        OPENMONITOR_ERROR_STR("Create background solid color brush failed."));
...
void CD2D1DeviceContextWindowSupport::CD2D1DeviceContextHelper::RebindRenderTargetSurface(Microsoft::WRL::ComPtr<IDXGISurface> p_surface)
{
    ...
    ThrowIfFailed<CD2D1Exception>(
        ...
        OPENMONITOR_ERROR_STR("Create ID2D1Bitmap1 from dxgi surface failed."));
...
void CD2D1DeviceContextWindowSupport::CDCompositionHelper::InitializeSwapChain(const D2D1_SIZE_U size)
{
    ...
    ThrowIfFailed<CDxgiException>(
        CDxgi1Support2::GetFactory()->CreateSwapChainForComposition(
            ...
            nullptr,
            &m_p_swap_chain1),
        OPENMONITOR_ERROR_STR("Create swap chain for composition failed."));
}
...
void CD2D1DeviceContextWindowSupport::CDCompositionHelper::ReinitializeDCompositionPart()
{
    ...
    ThrowIfFailed<CDCompositionException>(
        m_p_composition_device->CreateTargetForHwnd(
            ...
            topmost,
            &m_p_target),
        OPENMONITOR_ERROR_STR("Create dcomposition target for hwnd failed."));

    ThrowIfFailed<CDCompositionException>(
        m_p_composition_device->CreateVisual(&m_p_visual),
        OPENMONITOR_ERROR_STR("Create dcomposition visual failed."));
}
    ...
    -> Microsoft::WRL::ComPtr<IDXGISurface>
{
    ...
    else
    {
        ThrowIfFailed<CDxgiException>(
            m_p_swap_chain1->ResizeBuffers(
                ...
                DXGI_FORMAT_UNKNOWN,
                0),
            OPENMONITOR_ERROR_STR("Resize composition swap chain failed."));
    }
    ...
    ThrowIfFailed<CDxgiException>(
        m_p_swap_chain1->GetBuffer(
            0,
            IID_PPV_ARGS(&result)),
        OPENMONITOR_ERROR_STR("Get buffer from composition swap chain failed."));
    m_size = size;
    return result;
}
...
void CD2D1DeviceContextWindowSupport::CDCompositionHelper::Present()
{
    ...
    ThrowIfFailed<CDxgiException>(
        ...
        OPENMONITOR_ERROR_STR("Call IDXGISwapChain::Present(1, 0) failed."));
    ThrowIfFailed<CDCompositionException>(
        m_p_composition_device->Commit(),
        OPENMONITOR_ERROR_STR("Commit dcomposition draw call failed."));
}
...
bool CD2D1DeviceContextWindowSupport::CDCompositionHelper::IsInvalid() const
{
    ...
    ThrowIfFailed<CDCompositionException>(
        ...
        OPENMONITOR_ERROR_STR("Check dcomposition device state failed."));
    return result == FALSE;
}
    ...
    -> Microsoft::WRL::ComPtr<ID3D10Texture2D>
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        p_device1->CreateTexture2D(
            ...
            NULL,
            &result),
        OPENMONITOR_ERROR_STR("CD2D1DeviceContextWindowSupport create texture2D failed."));
    ...
    -> Microsoft::WRL::ComPtr<IDXGISurface>
{
    ...
    ThrowIfFailed<CD3D10Exception1>(
        ...
        OPENMONITOR_ERROR_STR("Get IDXGISurface1 from D2D render target texture failed."));
...
{
    OPENMONITOR_CD2D1BITMAPCACHE_LOCK_CACHE_MAP_AND_EXPIRE_INTERVAL(m_sp_data);
    ...
    -> ComPtr<ID2D1Bitmap>
{
    ...
    ThrowIfFailed<CWICException>(
        CWICFactory::GetWIC()->CreateBitmapFromHBITMAP(
            ...
            &p_wic_bitmap),
        OPENMONITOR_ERROR_STR("Call IWICImagingFactory::CreateBitmapFromHBITMAP failed."));
    ...
    ThrowIfFailed<CD2D1Exception>(
        p_render_target->CreateBitmapFromWicBitmap(
            p_wic_bitmap.Get(),
            &result),
        OPENMONITOR_ERROR_STR("Call ID2D1RenderTarget::CreateBitmapFromWicBitmap failed."));
...
{
    OPENMONITOR_CD2D1BITMAPCACHE_LOCK_GC_INTERVAL(m_sp_data);
...
void CD2D1BitmapCache::GCImpl(std::shared_ptr<HeapData> sp_data)
{
    ...
    OPENMONITOR_CD2D1BITMAPCACHE_LOCK_CACHE_MAP_AND_EXPIRE_INTERVAL(sp_data);
    ...
    try
    {
        if (m_gdi_interop_object.HasValue())
        {
            ...
            ThrowIfFailed<CD2D1Exception>(
                ...
                OPENMONITOR_ERROR_STR("Call ID2D1RenderTarget::Flush() failed."));

            ThrowIfFailed<CD3D10Exception1>(
                waiter.Wait(),
                OPENMONITOR_ERROR_STR("Draw call failed."));
            ...
            ThrowIfFailed<CD2D1Exception>(
                ...
                OPENMONITOR_ERROR_STR("Create ID2D1Bitmap from IDXGISurface1 failed."));
        ...
        ThrowIfFailed<CD2D1Exception>(
            ...
            OPENMONITOR_ERROR_STR("Call ID2D1RenderTarget::EndDraw() failed."));
    }
...
void CTaskBarDlgDrawCommon::DrawWindowText(CRect rect, LPCTSTR lpszString, COLORREF color, Alignment align, bool draw_back_ground, bool multi_line, BYTE alpha)
{
    ...
    ThrowIfFailed<CDWriteException>(
        CDWriteSupport::GetFactory()->CreateTextLayout(
            ...
            &p_text_layout),
        OPENMONITOR_ERROR_STR("Function CreateTextLayout failed."));
...
CTaskBarDlgDrawBuffer::~CTaskBarDlgDrawBuffer()
{
    ...
    try
    {
        ThrowIfFailed<CD3D10Exception1>(
            ...
            OPENMONITOR_ERROR_STR("Get DC from IDXGISurface1 failed."));

...
wstring CCommon::GetAppDataConfigDir()
{
    ...
    app_data_path += L"\\OpenMonitor\\";
    CreateDirectory(app_data_path.c_str(), NULL);       //如果C:/User/用户名/AppData/Roaming/OpenMonitor不存在，则创建它
...
{
    wstring raw_string;
    wstring user_agent{ L"OpenMonitor/" };
    user_agent += VERSION;
...
void CCommon::SetColorMode(ColorMode mode)
{
    ...
    case ColorMode::Default:
        ...
        {
            COpenMonitorApp::self->m_taskbar_data.dft_back_color = RGB(0, 0, 1);
            COpenMonitorApp::self->m_taskbar_data.dft_transparent_color = RGB(0, 0, 1);
        }
        else
        {
            COpenMonitorApp::self->m_taskbar_data.dft_back_color = 0;
            COpenMonitorApp::self->m_taskbar_data.dft_transparent_color = 0;
        }
        COpenMonitorApp::self->m_taskbar_data.dft_status_bar_color = 0x005A5A5A;
        COpenMonitorApp::self->m_taskbar_data.dft_text_colors = 0x00ffffffU;
        COpenMonitorApp::self->m_cfg_data.m_dft_notify_icon = 0;
        break;
    case ColorMode::Light:
        COpenMonitorApp::self->m_taskbar_data.dft_back_color = 0x00D3D2D2;
        COpenMonitorApp::self->m_taskbar_data.dft_transparent_color = 0x00D3D2D2;
        COpenMonitorApp::self->m_taskbar_data.dft_status_bar_color = 0x00A5A5A5;
        COpenMonitorApp::self->m_taskbar_data.dft_text_colors = 0x00000000U;
        COpenMonitorApp::self->m_cfg_data.m_dft_notify_icon = 4;
        break;
    default:
        break;
    }
